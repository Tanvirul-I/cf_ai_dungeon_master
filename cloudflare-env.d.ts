/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 6450306596912bb013ccd0598f88c275)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* ai-dungeon-master */;
	}
}
interface CloudflareEnv extends Cloudflare.Env {
  AI: Ai;
  GAME_ROOM: DurableObjectNamespace<import("./src/game-engine").GameRoom>;
}
